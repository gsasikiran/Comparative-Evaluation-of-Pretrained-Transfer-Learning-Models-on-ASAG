...
if __name__ == '__main__':
    ...
    for stu_ans in student_answers:
        ...
        bert_similarity_score[stu_ans] = similarity_tools.get_cosine_similarity(text_1_embed, text_2_embed)
        print(bert_similarity_score)
    # Saving similarity scores to json
    with open('json_files/bert_similarity_score.json', 'w') as fp:
        json.dump(bert_similarity_score, fp)
