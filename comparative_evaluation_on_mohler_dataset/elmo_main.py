...
if __name__ == '__main__':
    ...
    for stu_ans in student_answers:
        ...
        elmo_similarity_score[stu_ans] = similarity_tools.get_cosine_similarity(text_1_embed, text_2_embed)

    # Saving similarity scores to json
    with open('json_files/elmo_similarity_score.json', 'w') as fp:
        json.dump(elmo_similarity_score, fp)
